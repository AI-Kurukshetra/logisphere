/**
 * Generate demo frames for video testing
 * Creates placeholder frames to test the video pipeline without full page recording
 */
...
async function generateDemoFrames() {
  ...
  for (let pageIndex = 0; pageIndex < pageScripts.length; pageIndex++) {
    ...
    // Create 30-45 frames per page (1-1.5 seconds at 30fps)
    const frameCount = 40;
